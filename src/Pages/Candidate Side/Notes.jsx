...
export default function NotesEditorPage() {
    ...
    const interviews = myinterviews?.filter(
        (interview) =>
    ...
    const editor = useEditor({
        ...
        content:
            "<p>Start writing candidate notes, interview feedback, or meeting summaries here...</p>",
    });
     ...
     * It does NOT overwrite previousNote/currentNote revision history.
     */
    useEffect(() => {
        if (!editor) return;
            ...
            timer = setTimeout(() => {
                ...
                if (savedData) {
                    try {
                        ...
                        console.error(
                            "Failed to read saved candidate notes:",
                            error
                        );
                    }
                }
    ...
    useEffect(() => {
        ...
        try {
            ...
            console.error(
                "Failed to restore candidate notes:",
                error
            );
        }
    }, [editor]);
    ...
    const handleClearConfirm = () => {
        localStorage.removeItem("candidate_notes_data");
    ...
    const handleExportWord = () => {
        ...
        a.href = url;
        a.download = "Candidate-Notes-Document.doc";
     ...
     * ------------------------------------------------------------
     */
    const handleInsertMention = (interview) => {
        const nameToInsert = interview.company;
