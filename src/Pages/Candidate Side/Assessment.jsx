...
export default function Assessment() {
  ...
  const textFieldStyle = {
    ...
    "& .MuiInputLabel-root": {
      color: subText,
      fontSize: { xs: ".82rem", sm: ".9rem", md: ".95rem" },
    },
  ...
  return (
    <CandidateLayout>
      ...
      >
        <Typography
          sx={{
            fontSize: { xs: "1.4rem", sm: "1.7rem", md: "2rem", lg: "2.15rem" },
            fontWeight: 850,
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: { xs: 1, sm: 1.5 } }}>
            ...
            >
              ...
              <Typography
                sx={{
                  fontWeight: 800,
                  fontSize: { xs: ".68rem", sm: ".78rem", md: ".85rem" },
                  letterSpacing: "0.02em"
                }}
              >
                58:45 REMAINING
          ...
          <Box>
            ...
            <Box
              ...
              sx={{
                ...
                pl: 2,
                color: subText,
                fontSize: { xs: ".74rem", sm: ".82rem", md: ".88rem" },
                lineHeight: 1.6,
              }}
            >
          ...
          >
            ...
            <Typography
              sx={{
                color: textColor,
                fontWeight: 700,
                fontSize: { xs: ".88rem", sm: ".98rem", md: "1.05rem" },
                mb: 2,
              }}
            >
        ...
        >
          <Button
            ...
            sx={{
              ...
              fontWeight: 700,
              textTransform: "none",
              fontSize: { xs: ".8rem", sm: ".86rem", md: ".92rem" },
