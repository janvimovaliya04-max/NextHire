...
export default function CandidateDashboard() {
  ...
  // Dynamic candidate name calculation
  const candidateName =
    user?.name ||
  ...
  const cards = [
    ...
    },
    {
      ...
      link: "/candidate/candidate-assessment",
    },
    {
      title: "Interviews",
  ...
  return (
    <CandidateLayout>
      ...
      <Grid container spacing={{ xs: 2, sm: 2.5, md: 3 }} sx={{ mb: 6 }}>
