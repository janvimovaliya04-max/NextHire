      ...
      >
        ...
        <Box>
          ...
          <Typography sx={{ color: subText, mt: 1 }}>
            Candidate: <b>{interviewData.candidate}</b> • Position:{" "}
            <b>{interviewData.position}</b>
          </Typography>
          <Button
            component={Link}
            ...
            sx={{
              ...
              "&:hover": {
                bgcolor: darkMode ? "rgba(20,184,166,.1)" : "rgba(20,184,166,.06)",
        ...
        <Box>
          ...
          >
            <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", mb: 1 }}>
              <Typography sx={{ fontWeight: 800, fontSize: "1rem", color: darkMode ? "#fff" : "#0f172a" }}>
                Coding Question
              </Typography>
              <Chip
                label="Medium"
            ...
            <Typography sx={{ fontWeight: 700, fontSize: ".92rem", color: darkMode ? "#e2e8f0" : "#1e293b", mb: 0.5 }}>
              Longest Substring Without Repeating Characters
            </Typography>
            <Typography sx={{ fontSize: ".85rem", color: subText, lineHeight: 1.6 }}>
              Given a string <code>s</code>, find the length of the longest substring without
              repeating characters. Implement an efficient solution and validate it against the
              provided test cases before submitting.
            </Typography>
          </Paper>
          <Paper
            elevation={6}
        ...
        >
          ...
          >
            {cameraActive ? (
              ...
              <Box sx={{ textAlign: "center", color: darkMode ? "#94a3b8" : "#475569" }}>
                <VideocamOffIcon sx={{ fontSize: 40, mb: 1, opacity: 0.7 }} />
            ...
            >
              ...
              {!micActive && (
                <MicOffIcon sx={{ fontSize: 14, color: "#f43f5e" }} />
              )}
            </Box>
          </Paper>
          ...
          >
            <Typography sx={{ fontWeight: 800, fontSize: ".95rem", mb: 1.5, color: darkMode ? "#fff" : "#0f172a" }}>
              Interview Notes
            </Typography>
            <TextField
              fullWidth
              ...
              sx={{
                "& .MuiOutlinedInput-root": {
                  ...
                  bgcolor: darkMode ? "rgba(15,23,42,.4)" : "rgba(248,250,252,.8)",
          ...
          >
            <Box sx={{ px: 2.5, py: 1.5, borderBottom: `1px solid ${borderColor}` }}>
              <Typography sx={{ fontWeight: 800, fontSize: ".9rem", color: darkMode ? "#fff" : "#0f172a" }}>
                Chat
              </Typography>
            </Box>
                  ...
                  <Box
                    sx={{
                      ...
                      bgcolor: msg.self
                        ...
                        : darkMode ? "rgba(255,255,255,.06)" : "#f1f5f9",
                      background: msg.self ? "linear-gradient(90deg,#14b8a6,#0d9488)" : undefined,
            ...
            <Box sx={{ display: "flex", gap: 1, p: 1.5, borderTop: `1px solid ${borderColor}` }}>
              <TextField
                size="small"
                fullWidth
              ...
              <IconButton
                ...
                sx={{
                  bgcolor: "rgba(20,184,166,.15)",
                  color: primaryColor,
                  "&:hover": { bgcolor: "rgba(20,184,166,.25)" },
                }}
              >
          ...
          <IconButton
            ...
            sx={{
              bgcolor: micActive
                ? "rgba(20,184,166,.15)"
                : "rgba(244, 63, 94, 0.15)",
              color: micActive ? "#14b8a6" : "#f43f5e",
              "&:hover": {
                bgcolor: micActive ? "rgba(20,184,166,.25)" : "rgba(244, 63, 94, 0.25)",
              },
              borderRadius: 3,
              p: 1.5,
            }}
          ...
          <IconButton
            ...
            sx={{
              bgcolor: micActive
                ? "rgba(20,184,166,.15)"
                : "rgba(244, 63, 94, 0.15)",
              color: cameraActive ? "#14b8a6" : "#f43f5e",
              "&:hover": {
                bgcolor: cameraActive ? "rgba(28, 184, 166, 0.25)" : "rgba(244, 63, 94, 0.25)",
              },
              borderRadius: 3,
              p: 1.5,
            }}
