...
export default function NotesEditorPage() {
    ...
    const applyTemplate = (type) => {
        ...
        let templateHtml = "";
        if (type === "tech") {
            templateHtml = `<h3>Technical Evaluation Notes</h3><p><strong>Candidate Name:</strong> </p><p><strong>Target Role:</strong> </p><p><strong>Interview Round:</strong> [e.g., L1 Tech / L2 Architecture]</p><ul><li><p><strong>DSA & Algorithmic Thinking:</strong> </p></li><li><p><strong>System Design & Scalability:</strong> </p></li><li><p><strong>Code Quality & Clean Code Practices:</strong> </p></li><li><p><strong>Framework / Tech Stack Proficiency:</strong> </p></li></ul><p><strong>Key Strengths:</strong> </p><p><strong>Red Flags / Concerns:</strong> </p><p><strong>Recommendation Score:</strong> [1-5 Rating]</p><p><strong>Final Verdict:</strong> [Strong Hire / Hire / Weak Hire / Reject]</p>`;
        } else if (type === "behavioral") {
            templateHtml = `<h3>Behavioral & Culture Fit Assessment</h3><p><strong>Candidate Name:</strong> </p><p><strong>Interviewer:</strong> </p><ul><li><p><strong>Communication & Articulation:</strong> </p></li><li><p><strong>Problem Solving & Conflict Resolution:</strong> </p></li><li><p><strong>Ownership & Accountability:</strong> </p></li><li><p><strong>Teamwork & Alignment with Core Values:</strong> </p></li></ul><p><strong>Culture Fit Impression:</strong> </p><p><strong>Final Recommendation:</strong> [Recommended / Not Recommended]</p>`;
        } else if (type === "coding_debrief") {
            templateHtml = `<h3>Live Coding / Pair Programming Review</h3><p><strong>Candidate Name:</strong> </p><p><strong>Problem Statement Assigned:</strong> </p><ul><li><p><strong>Approach & Edge Cases Handled:</strong> </p></li><li><p><strong>Time & Space Complexity Awareness:</strong> </p></li><li><p><strong>Debugging & Troubleshooting Ability:</strong> </p></li></ul><p><strong>Code Completion Status:</strong> [Completed / Partially Completed / Failed]</p><p><strong>Overall Feedback:</strong> </p>`;
        } else if (type === "panel_debrief") {
            templateHtml = `<h3>Panel Interview Summary & Final Debrief</h3><p><strong>Candidate Name:</strong> </p><p><strong>Panel Members:</strong> </p><p><strong>Consensus Status:</strong> [Aligned / Mixed Opinions / Rejected]</p><ul><li><p><strong>Technical Competency Summary:</strong> </p></li><li><p><strong>Leadership / Seniority Alignment:</strong> </p></li></ul><p><strong>Next Action Items:</strong> [Proceed to HR / Offer Release / Hold]</p>`;
        }
            ...
            <Container maxWidth="lg" sx={{ mt: { xs: 2.5, sm: 4 }, mb: { xs: 4, sm: 6 }, px: { xs: 1.5, sm: 3 } }}>
                ...
                <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: { xs: 2, sm: 3 }, flexWrap: "wrap", gap: 2 }}>
                    ...
                    <Box sx={{ display: "flex", gap: { xs: 1, sm: 1.5 }, alignItems: "center", flexWrap: "wrap" }}>
                        ...
                        >
                            <MenuItem onClick={() => applyTemplate("tech")} sx={{ fontSize: { xs: "0.82rem", sm: "0.9rem" } }}>Technical Evaluation</MenuItem>
                            <MenuItem onClick={() => applyTemplate("behavioral")} sx={{ fontSize: { xs: "0.82rem", sm: "0.9rem" } }}>Behavioral & Culture Fit</MenuItem>
                            <MenuItem onClick={() => applyTemplate("coding_debrief")} sx={{ fontSize: { xs: "0.82rem", sm: "0.9rem" } }}>Live Coding Review</MenuItem>
                            <MenuItem onClick={() => applyTemplate("panel_debrief")} sx={{ fontSize: { xs: "0.82rem", sm: "0.9rem" } }}>Panel Debrief Summary</MenuItem>
                        </Menu>
