...
const CustomNode = ({ data, type }) => {
    ...
    return (
        <div
            className={`custom-flow-node ${isInput ? "start-node" : ""
        ...
        >
            ...
            <div className="node-content">
                {!isInput && <div className="node-dot" />}
...
const AnalyticsChartsFlow = () => {
    ...
    return (
        <div
            className="analytics-flow-wrapper"
            style={{
        ...
        >
            <style>{`
                ...
                .analytics-flow-wrapper .react-flow {
                    width: 100%;
                    height: 100%;
                }
                ...
                .analytics-flow-wrapper .custom-flow-node {
                    width: 250px;
                    min-width: 250px;
                    min-height: 58px;
                ...
                .analytics-flow-wrapper .start-node {
                    width: 180px;
                    min-width: 180px;
                    min-height: 58px;
                ...
                .analytics-flow-wrapper .node-content {
                    display: flex;
                ...
                .analytics-flow-wrapper .node-dot {
                    width: 8px;
                    height: 8px;
                ...
                .analytics-flow-wrapper .custom-handle {
                    width: 9px;
                    height: 9px;
...
export default AnalyticsChartsFlow;