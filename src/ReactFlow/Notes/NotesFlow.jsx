    ...
    return (
        ...
        >
            <style>{`
                ...
                .notes-flow-wrapper .custom-flow-node {
                    width: 250px;
                    min-width: 250px;
                    min-height: 58px;
                ...
                .notes-flow-wrapper .node-content {
                    display: flex;
                ...
                .notes-flow-wrapper .custom-handle {
                    width: 9px;
                    height: 9px;
